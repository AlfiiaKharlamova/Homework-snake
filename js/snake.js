...
/**
 добавдение обработчика событий
 **/
    ...
    return function(config) {
        ...
        function recordScore() {
            ...
            if (me.snakeLength > highScore) {
                alert('Поздравляем! Вы побили свой предыдущий рекорд ' + highScore + '.');
        ...
        /**
         Этот метод выполняется для каждого движения змейки. Он определяет,
         куда пойдет змея и что с ней будет.
         */
        me.go = function() {
        ...
        /**
         Этот метод вызывается, когда змея есть еду.
         */
        me.eatFood = function() {
...
SNAKE.Board = SNAKE.Board || (function() {
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmLengthPanel.innerHTML = "Длина змейки: 1";

            elmHighscorePanel = document.createElement("div");
            elmHighscorePanel.className = "snake-panel-component";
            elmHighscorePanel.innerHTML = "Рекорд: " + (localStorage.jsSnakeHighScore || 0);
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "Игра змейка <p></p>Для движения змейки используйте <strong>стрелки</strong> на своей клавиатуре " + fullScreenText + "<p></p>";
            var welcomeStart = document.createElement("button");
            welcomeStart.appendChild(document.createTextNode("Играть"));
        ...
        function createGameEndElement(message, elmId, elmClassName) {
            ...
            gameEndTxt.innerHTML = "Игра змейка <p></p>" + message + "<p></p>";
            var gameEndStart = document.createElement("button");
            gameEndStart.appendChild(document.createTextNode("Попробовать снова"));
        ...
        function createTryAgainElement() {
            return createGameEndElement("Вы проиграли :(", "sbTryAgain", "snake-try-again-dialog");
        }

        function createWinElement() {
            return createGameEndElement("Вы выиграли! :D", "sbWin", "snake-win-dialog");
        }
        ...
        me.foodEaten = function() {
            elmLengthPanel.innerHTML = "Длина змейки: " + mySnake.snakeLength;
            if (mySnake.snakeLength > localStorage.jsSnakeHighScore)
            {
                localStorage.setItem("jsSnakeHighScore", mySnake.snakeLength);
                elmHighscorePanel.innerHTML = "Рекорд: " + localStorage.jsSnakeHighScore;
            }
